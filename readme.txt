...
You can can either go into the Support forum, or in the [ACF Polylang Sync Repository](https://github.com/mcguffin/acf-polylang-sync).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com/mcguffin/acf-polylang-sync)
(See above as well.)
...
3. type `git clone git@github.com:mcguffin/acf-polylang-sync.git`
...
Either post it on the [GitHub-repo](https://github.com/mcguffin/acf-polylang-sync) or—if you cloned the repository—send me a pull request.
